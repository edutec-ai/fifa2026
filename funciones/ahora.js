...
function abrirModalPartidoInaugural() {
    ...
    <div style="background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/fifa2026/img/fondoHorizontal.jpg'); background-size: cover; background-position: center bottom; border-radius: 20px; padding: 16px; margin-bottom: 20px;">
            ...
            <style>
                .ahora-header { 
                    background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), 
                                url('/fifa2026/img/fondoHorizontal.jpg');
