...
function abrirModalPartidoInaugural() {
    ...
    <div style="background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('https://img.magnific.com/vector-gratis/estadio-futbol_1284-22432.jpg?semt=ais_hybrid&w=740&q=80'); background-size: cover; background-position: center bottom; border-radius: 20px; padding: 16px; margin-bottom: 20px;">
...
setTimeout(() => {
    ...
    ultraTest.style.cssText = `
        ...
        width: 200px;
        height: 150px;
        background: url('/fifa2026/img/fondoHorizontal.jpg') center/cover no-repeat;
