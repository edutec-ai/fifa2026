...
// CORREGIDO:
// - Hardcodeo est=4 para Canadá vs Bosnia ✅ TERMINADO
// - Hardcodeo est=4 para EE. UU. vs Paraguay ✅ TERMINADO
// - Marcador EN VIVO muestra el valor real de la API (0-0 si no hay datos)
...
// ========== CORRECCIÓN DE FECHAS SEGÚN VELNEO CON HARDCODE est=4 ==========
// TODO: Cuando el experto de Velneo solucione la actualización automática del campo 'est',
// eliminar los hardcodes y restaurar la lógica original que lee 'est' desde la API.
function corregirFechasSegunVelneo(partidos) {
    return partidos.map(p => {
        // Canadá vs Bosnia → 12/06/2026 14:00 - TERMINADO (est=4)
        ...
        // EE.UU. vs Paraguay → 12/06/2026 20:00 - TERMINADO (est=4)
        if ((p.nom_loc === 'EE. UU.' && p.nom_vis === 'Paraguay') ||
            (p.nom_loc === 'Paraguay' && p.nom_vis === 'EE. UU.')) {
            return { ...p, fch: '2026-06-12', hor: '20:00:00', est: 4 };
        }
        return p;
    });
}
...
async function cargarPartidos() {
    try {
        ...
        // ✅ CORRECCIÓN: Aplicar fechas y estados de Velneo con hardcode
        ...
        // Cargar resultados reales para partidos terminados
